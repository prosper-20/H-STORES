...
from .views import initiate_payment_2, verify_payment, initiate_payment_3, verfiy_order_payment, initiate_payment_4, verify_payment2, delivery, getPrices, email_tester, delivery3, delivery2


urlpatterns = [
    path("prices/", getPrices, name="get-prices"),
    path("delivery/", delivery, name="delivery"),
    path("delivery2", delivery2, name="delivery2"),
